  ...
  *---------------------------------------------------------------------------
  ...
  if (_rc == 601) | (`overwrite_files') {
    ...
    *---------------------------------------------------------------------------
    ...
    foreach file in INT_STQ INT_PAR INT_SCQ {
    ...
    *---------------------------------------------------------------------------
    ...
    use "`temp_dir'\INT_STQ.dta", clear
    merge 1:1 cnt schoolid stidstd using "`temp_dir'\INT_PAR.dta", assert(master match) nogen
    merge m:1 cnt schoolid using "`temp_dir'\INT_SCQ.dta", assert(match) nogen
    ...
    *<_urban_>
    recode sc04q01 (1 = 0 "Rural") (2/5 = 1 "Urban") (7 = .a "Not Administered") (8 = .b "Invalid") (9 = .c "No Response"), gen(urban)
    label var urban "School is located in urban/rural area"
    *</_urban_>

    *<_urban_o_>
    decode sc04q01, gen(urban_o)
    ...
    *<_city_>
    recode sc04q01 (4/5 = 1 "City") (2/3 = 2 "Town") (1 = 3 "Village") (7 = -97) (8 = -98) (9 = -99), gen(city)
    ...
    *<_language_>
    gen language = st19q01 if !inlist(st19q01,7,8,9)
    ...
    *<_ece_>
    gen ece = st05q01 if !inlist(st05q01,7,8,9)
    ...
    *<_school_type_>
    recode schtype (1 = 3) (3 = 1), gen(school_type)
    replace school_type = -97 if schtype == 7
    replace school_type = -98 if schtype == 8
    replace school_type = -99 if schtype == 9
    ...
    *<_school_type_o_> - original school type variable
    ...
    replace school_type_o = -97 if inlist(sc02q01,7)
