  ...
  *---------------------------------------------------------------------------
  ...
  if (_rc == 601) | (`overwrite_files') {
    ...
    *---------------------------------------------------------------------------
    ...
    foreach file in INT_stui INT_schi {
    ...
    *---------------------------------------------------------------------------
    ...
    use "`temp_dir'\INT_stui.dta", clear
    merge m:1 cnt schoolid using "`temp_dir'\INT_schi.dta", assert(match) nogen
    ...
    *<_age_>
    mvdecode age, mv(96 = .z \ 97 = .a \ 98 = .b \ 99 = .c)
    ...
    *<_city_>
    recode sc01q01 (4/5 = 1 "City") (2/3 = 2 "Town") (1 = 3 "Village") (7 = -97) (8 = -98) (9 = -99), gen(city)
    label var city "School is located in city (1), town (2), village (3)"
    *</_city_>

    *<_native_>
    recode immig (1 = 1 "N") (2 = 3 "SG") (3 = 2 "FG") (9 = -99), gen(native)
    ...
    *<_language_>
    gen language = st16q01 if !inlist(st16q01,97,98,99)
    replace language = 2 if inlist(st16q01, 2,3,4)
    ...
    *<_ece_>
    gen ece = st20q01 if !inlist(st20q01,7,8,9)
    replace ece = -97 if inlist(st20q01, 7)
    replace ece = -98 if inlist(st20q01, 8)
