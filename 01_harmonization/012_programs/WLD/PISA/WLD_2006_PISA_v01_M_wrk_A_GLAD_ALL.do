  ...
  *---------------------------------------------------------------------------
  ...
  if (_rc == 601) | (`overwrite_files') {
    ...
    *---------------------------------------------------------------------------
    ...
    foreach file in INT_Stu INT_Par INT_Sch {
    ...
    *---------------------------------------------------------------------------
    ...
    merge m:1 cnt schoolid using "`temp_dir'\INT_Sch.dta", assert(match) nogen
    ...
    *<_score_assessment_subject_pv_>
    foreach pv in 1 2 3 4 5 {
      ...
      * Coding missing pv values in read
      mvdecode  score_pisa_read_`auxpv', mv(9997 = .z)
    ...
    *<_urban_>
    recode sc07q01 (1 = 0 "Rural") (2/5 = 1 "Urban") (7 = .a "Not Administered") (8 = .b "Invalid") (9 = .c "No Response"), gen(urban)
    label var urban "School is located in urban/rural area"
    *</_urban_>

    *<_urban_o_>
    decode sc07q01, gen(urban_o)
