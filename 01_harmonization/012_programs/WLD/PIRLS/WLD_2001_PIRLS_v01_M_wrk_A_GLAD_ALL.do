  ...
  *---------------------------------------------------------------------------
  ...
  if (_rc == 601) | (`overwrite_files') {
    ...
    *---------------------------------------------------------------------------
    ...
    foreach cnt in ARG BGR BLZ CAN COL COT CQU CYP CZE DEU ENG FRA GRC HKG HUN IRN ISL ISR ITA KWT LTU LVA MAR MDA MKD NLD NOR NZL ROM RUS SCO SE3 SGP SVK SVN SWE TUR USA {
    ...
    *<_idgrade_>
    * Cleaning grades for Russia: Participated in Grade 4 (per report)
    replace idgrade = 4 if idcntry == 643  // RUS = Russia
    ...
    *<_age_>
    gen age = asdgage  if  !missing(asdgage)  &  asdgage != 99
    label var age "Learner age at time of assessment"
    *</_age_>

    *<_urban_>
    gen byte urban = (inlist(acbgclos, 2, 3, 4))  if  !missing(acbgclos)  &  acbgclos != 9  &  acbgclos != 6
    label var urban "School is located in urban/rural area"
    *</_urban_>

    *<_urban_o_>
    decode acbgclos, g(urban_o1)
    ...
    *Generating variable for Socio-Economic Status:
    foreach var of varlist ASBGBOOK ASBGPS1 ASBGPS2 ASBGPS3 ASBGPS4 ASBGPS5 ASBGPS6 ASBGPS7 ASBGPS8 ASBGPS9 ASBGPS10 ASBGPS11 ASBGPS12 ASBHEDUF ASBHEMPF ASBHMJF ASBHEDUM ASBHEMPM ASBHMJM ASDHEDUP ASDHPEMP {
      tab `var'
      replace `var' = . if inlist(`var',9,99)
    }
    tab ASBGBOOK, gen(dbooks)
    foreach var of varlist ASBGPS1 ASBGPS2 ASBGPS3 ASBGPS4 ASBGPS5 ASBGPS6 ASBGPS7 ASBGPS8 ASBGPS9 ASBGPS10 ASBGPS11 ASBGPS12  {
      replace `var' = 0 if  `var' == 2
    }
    alphawgt dbooks* ASBGPS1 ASBGPS2 ASBGPS3 ASBGPS4 ASBGPS5 ASBGPS6 ASBGPS7 ASBGPS8 ASBGPS9 ASBGPS10 ASBGPS11 ASBGPS12 [weight = TOTWGT], detail std item label
    bysort IDCNTRY: mdesc dbooks* ASBGPS1 ASBGPS2 ASBGPS3 ASBGPS4 ASBGPS5 ASBGPS6 ASBGPS7 ASBGPS8 ASBGPS9 ASBGPS10 ASBGPS11 ASBGPS12
    foreach var of varlist dbooks* ASBGPS1 ASBGPS2 ASBGPS3 ASBGPS4 ASBGPS5 ASBGPS6 ASBGPS7 ASBGPS8 ASBGPS9 ASBGPS10 ASBGPS11 ASBGPS12 {
    ...
    *Identifying those countries:
    foreach var of varlist dbooks* ASBGPS1 ASBGPS2 ASBGPS3 ASBGPS4 ASBGPS5 ASBGPS6 ASBGPS7 ASBGPS8 ASBGPS9 ASBGPS10 ASBGPS11 ASBGPS12 {
      gen `var'_tag_missing = .
    }

    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std ASBGPS6_std ASBGPS7_std ASBGPS8_std ASBGPS9_std ASBGPS10_std ASBGPS11_std ASBGPS12_std  [weight = TOTWGT]
    predict HOMEPOS
    pca  dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std ASBGPS6_std ASBGPS7_std ASBGPS8_std ASBGPS9_std ASBGPS10_std ASBGPS11_std  [weight = TOTWGT]
    predict HOMEPOS1
    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std ASBGPS6_std ASBGPS7_std ASBGPS8_std ASBGPS9_std ASBGPS10_std [weight = TOTWGT]
    predict HOMEPOS2
    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std ASBGPS6_std ASBGPS7_std ASBGPS8_std ASBGPS9_std [weight = TOTWGT]
    predict HOMEPOS3
    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std ASBGPS6_std ASBGPS7_std ASBGPS8_std [weight = TOTWGT]
    predict HOMEPOS4
    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std ASBGPS6_std ASBGPS7_std [weight = TOTWGT]
    predict HOMEPOS5
    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std ASBGPS6_std  [weight = TOTWGT]
    predict HOMEPOS6
    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std ASBGPS5_std  [weight = TOTWGT]
    predict HOMEPOS7
    pca dbooks*_std ASBGPS1_std ASBGPS2_std ASBGPS3_std ASBGPS4_std [weight = TOTWGT]
    predict HOMEPOS8
    forvalues i = 1/8 {
      replace HOMEPOS = HOMEPOS`i' if missing(HOMEPOS)
    }

    *Changing the direction of education and employment variables,
    recode ASDHEDUP (5=1) (4=2) (3=3) (2=4) (1=5), gen(HIEDU)
    recode ASDHPEMP (4=1) (3=2) (2=3) (1=4), gen(HIOCC)

    *Filling missing values for HIEDU and HIOCC
    ...
    *HIOCC HIEDU missing for USA, Kuwait and Morocco
