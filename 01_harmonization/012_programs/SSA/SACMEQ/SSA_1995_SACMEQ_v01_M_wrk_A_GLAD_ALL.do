  ...
  *---------------------------------------------------------------------------
  ...
  if (_rc == 601) | (`overwrite_files') {
    ...
    *<_score_assessment_subject_pv_>
    clonevar  score_scmeq_read = xralocp
    label var score_scmeq_read "Sacmeq score for reading"
    char      score_scmeq_read[clo_marker] "number"
    *</_score_assessment_subject_pv_>

    *<_level_assessment_subject_pv_>
    clonevar  level_scmeq_read = xralevp
    label var level_scmeq_read "Sacmeq level for reading"
    char      level_scmeq_read[clo_marker] "factor"
    *</_level_assessment_subject_pv_>
