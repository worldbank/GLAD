...
lastsave:    9 Oct 2019 20:20:33 by wb552057
~~~~


About the **146 variables** in this dataset:
...
urban         39535      2  .6752751          0         1  School is located in urban/rural area
urban_o       39535      4         .          .         .  Original variable of urban: school is located in area described as
...
---------------------+-----------------------------------
  ...
  5. |       2     lp05                            no harmonization |
     |--------------------------------------------------------------|
  6. |       6     lp01   hpro_read_01 = (level_pasec_read_01 >= 4) |
  7. |       6     lp02   hpro_read_02 = (level_pasec_read_02 >= 4) |
  8. |       6     lp03   hpro_read_03 = (level_pasec_read_03 >= 4) |
  9. |       6     lp04   hpro_read_04 = (level_pasec_read_04 >= 4) |
 10. |       6     lp05   hpro_read_05 = (level_pasec_read_05 >= 4) |
     +--------------------------------------------------------------+
